...
source("CODES/ESTUDO DE SIMULAÇÃO/ARQUIVOS SUPLEMENTARES/GENERATION_FUNCTIONS.R")
source("CODES/ESTUDO DE SIMULAÇÃO/ARQUIVOS SUPLEMENTARES/MODELING_FUNCTIONS.R")
...
saveRDS(df.samples, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 1000/DATA_SIMULATED_1000.rds")

# Salvar Resultados
openxlsx::write.xlsx(df.rls, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 1000/SIMULATION_RESULTS_1000.xlsx")