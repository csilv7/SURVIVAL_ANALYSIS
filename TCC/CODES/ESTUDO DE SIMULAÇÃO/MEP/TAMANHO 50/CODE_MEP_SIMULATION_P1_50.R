...
saveRDS(df.samples, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 50/DATA_SIMULATED_50.rds")

# Salvar Resultados
openxlsx::write.xlsx(df.rls, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 50/SIMULATION_RESULTS_50.xlsx")