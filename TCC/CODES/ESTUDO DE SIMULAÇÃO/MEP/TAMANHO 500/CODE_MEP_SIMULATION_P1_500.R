...
saveRDS(df.samples, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 500/DATA_SIMULATED_500.rds")

# Salvar Resultados
openxlsx::write.xlsx(df.rls, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 500/SIMULATION_RESULTS_500.xlsx")