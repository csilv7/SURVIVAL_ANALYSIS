...
saveRDS(df.samples, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 100/DATA_SIMULATED_100.rds")

# Salvar Resultados
openxlsx::write.xlsx(df.rls, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 100/SIMULATION_RESULTS_100.xlsx")