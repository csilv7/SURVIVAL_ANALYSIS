...
saveRDS(df.samples, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 30/DATA_SIMULATED_30.rds")

# Salvar Resultados
openxlsx::write.xlsx(df.rls, file = "CODES/ESTUDO DE SIMULAÇÃO/MEP/TAMANHO 30/SIMULATION_RESULTS_30.xlsx")